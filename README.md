...
**สรุปสถิติหลังตรวจทาน (ณ 10 ก.ค. 2569):**

- จุดติดตามสถานะปี 2567+2568 รวม 204 รายการ = **จุดจริงไม่ซ้ำ 156 จุด** (ต่อเนื่องสองปี 48 จุด)
- สถานะรายจุดจริง (ปีล่าสุด): **เสร็จสิ้น 133 จุด (85.3%)** · อยู่ระหว่างดำเนินการ 15 จุด · ติดปัญหาอุปสรรค 8 จุด
- ความคืบหน้าเฉลี่ย (milestone-based, น้ำหนักเท่ากันทุกจุด, แยกรายปี): ปี 2567 = **86.1%** · ปี 2568 = **76.9%**
...
- **เกณฑ์สถานะ (ยืนยัน 10 ก.ค. 2569):** `0%` = ติดปัญหาอุปสรรค · `1–99%` = อยู่ระหว่างดำเนินการ · `100%` = เสร็จสิ้น — ใช้ชุดคำนี้ทุกหน้าของ dashboard
- หัวข้อ "สถานะจุดที่ยังดำเนินการไม่แล้วเสร็จ" แสดง**จุดจริงคงค้าง 23 จุด**จากสถานะล่าสุดในไฟล์ข้อมูล (ติดปัญหาอุปสรรค 8 · อยู่ระหว่างดำเนินการ 15) พร้อมข้อความปัญหาอุปสรรครายจุดจากคอลัมน์หมายเหตุ — สร้างอัตโนมัติโดย `scripts/rebuild_data.py`
