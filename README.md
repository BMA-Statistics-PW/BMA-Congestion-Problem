...
- สถานะรายจุดจริง (ปีล่าสุด): **เสร็จสิ้น 133 จุด (85.3%)** · ดำเนินการบางส่วน 15 จุด · ติดปัญหาดำเนินการ 8 จุด
...
- หัวข้อ "สถานะจุดที่ยังดำเนินการไม่แล้วเสร็จ" ใน dashboard แสดง**จุดจริงคงค้าง 23 จุด**จากสถานะล่าสุดของชุดข้อมูล (อยู่ระหว่างดำเนินการ 13 · พื้นที่ก่อสร้างรถไฟฟ้า 4 · นอกอำนาจ กทม. 2 · ใช้มาตรการชั่วคราว 2 · ข้อจำกัดทางกายภาพ 2) — สร้างอัตโนมัติโดย `scripts/rebuild_data.py` แทน snapshot รายงาน 21 จุดรอบก่อน
