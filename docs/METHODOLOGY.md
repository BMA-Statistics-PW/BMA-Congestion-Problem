...
| **สถานะจุดจริง** | ใช้สถานะ **ปีล่าสุด** ของจุดนั้น | เสร็จสิ้น 133 (85.3%) · อยู่ระหว่างดำเนินการ 15 · ติดปัญหาอุปสรรค 8 |
...
- **เกณฑ์และคำเรียกสถานะ (ยืนยันโดยผู้ใช้ 10 ก.ค. 2569):** `100%` = **เสร็จสิ้น** · `1–99%` = **อยู่ระหว่างดำเนินการ** · `0%` = **ติดปัญหาอุปสรรค** — ใช้ชุดคำนี้เหมือนกันทุกหน้า และใช้ **"นอกอำนาจ กทม."** สำหรับจุดของหน่วยงานอื่น
